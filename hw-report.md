...
Критерий на 7. <br>
Скомпилированы и отредактированы программы на ассемблере, в виде 6 единиц компиляции. <br>
Реализован файловый ввод/вывод (после имени исполняемого файла в командной строке достаточно ввести символ 2). <br>
<br>

Критерий на 8. <br>
Реализована генерация исходной строки (псевдослучайная) и добавлена функция замера времени формирования новой строки с помощью clock_gettime. <br>
Программа генерирует случайную строку, если в качестве `option` подавался символ, отличный от 1 или 2 (но не NULL). <br>
Время замерялось перед формированием новой строки и перед выводом полученной строки с числами, разница показателей есть время заполнения. <br>
<br>
