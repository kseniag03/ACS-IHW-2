...
По размеру файлов асм: с -Os (но обгоняет оптимизатор по скорости всего на 0,0001 секунду, скорее всего, при большем кол-ве замеров он будет работать медленнее) <br>
