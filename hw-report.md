...
| ----------------------|:------------------:| :------------------:|:-------------------:|:------------------------------------------:|
| размер асм-файла	| 12 588 байт        | 12 257 байт         | - байт         | - байт                               |
| размер испол. файла	| 17 120 байт        | 17 240 байт         | - байт         | - байт                                |
| время работы		| 738 438.1 ns       | 427 981.7 ns        | - ns       | - ns                               |
...
!!!!  ВЫПОЛНЕНЫ ЗАМЕРЫ ТОЛЬКО ДЛЯ СИ БЕЗ ФЛАГОВ   !!!!
