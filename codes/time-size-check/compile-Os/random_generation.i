# 0 "./random_generation.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "./random_generation.c"
  ...
  FILE *__restrict __stream)
{
  ...
  if ((((__typeof (__n)) 0 < (__typeof (__n)) -1 || (__builtin_constant_p (__n) && (__n) > 0)) && __builtin_constant_p ((((long unsigned int) (__n)) <= (sz) / (__size))) && (((long unsigned int) (__n)) <= (sz) / (__size))))
    {
# 370 "/usr/include/x86_64-linux-gnu/bits/stdio2.h" 3 4
...
# 4 "./random_generation.c" 2


# 5 "./random_generation.c"
extern const int SIZEMAX;
extern const int VALUEMAX;

void random_generation(char *pStr) {
    srand(time(
# 9 "./random_generation.c" 3 4
              ((void *)0)
# 9 "./random_generation.c"
                  ));
